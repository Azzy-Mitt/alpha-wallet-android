...
{
    // Azzy Mitt -> BELOW TWO lines changed to xDAI
    public static final long primaryChain = XDAI_ID;
    private static final String primaryChainName = C.XDAI_NETWORK_NAME;
    ...
    // AM -> Set to false
    public static boolean canAddTokens() { return false; }
    ...
    // AM -> Added and set to true
    public static boolean walletConnectSetting()
    {
        return false;
    }

    // AM -> Added and set to true
    public static boolean systemSettingsLayout() { return false; }

    // AM -> Added and set to true
    public static boolean supportSettingsLayout() { return false; }

    // AM -> Added and set to true
    public static boolean historyChart() { return false; }

    // AM -> Added and set to true THIS NEEDS MORE EXPLANATION & CHECKING
    // AM -> LOOK in ui - widget - entity - historychart
    // AM -> LOOK in tokenInfoFragment
    public static boolean stats() { return false; }

    // AM Other edites are to App - Widget - FunctionButtonBar.java ref: 491
}
